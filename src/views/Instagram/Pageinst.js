...
const Pageinst = () => {
  ...
  const submitHandler = () => {
    ...
    console.log(data);
    Instagram.postIntsgrame(data)
      .then(
        (response) => {
      //     Instagram.postApimertrics(pageid)
      //       .then((response) => {
      //    console.log("pgeid hhhh")
      //    Instagram.setIData(response.data);
      //  });
        

            console.log(response.data);
            // Instagram.setData(response.data);
          
            Instagram.setpageId(pageid);
          
            console.log(Instagram.getIData());
